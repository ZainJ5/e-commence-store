  ...
  return (
    <div className="overflow-hidden rounded-3xl border w-[95%] m-auto border-neutral-200 bg-[#214731] flex flex-row">
      <div className="w-[60%] xs:w-[65%] sm:w-[60%] lg:w-[55%] p-4 xs:p-6 sm:p-8 md:p-12 lg:p-16 flex flex-col justify-center">
        <h2 
          className="text-xl xs:text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-[#f0e6d2] font-serif mb-2 xs:mb-3 sm:mb-4 md:mb-6 leading-tight"
        ...
        <p 
          className="text-[#f0e6d2] text-xs xs:text-sm sm:text-base md:text-lg mb-3 xs:mb-4 sm:mb-6 md:mb-8 lg:mb-10 leading-relaxed line-clamp-2 sm:line-clamp-3 md:line-clamp-none"
        ...
        <div>
          <Link 
            href="/sale" 
            className="inline-block border border-[#f0e6d2] text-[#f0e6d2] rounded-full text-xs xs:text-sm sm:text-base px-4 xs:px-6 sm:px-8 md:px-12 py-1 xs:py-2 sm:py-3 hover:bg-[#f0e6d2] hover:text-[#214731] transition-all duration-300"
            style={{ fontFamily: "'Montserrat', sans-serif" }}
          >
            Shop Now
          </Link>
