...
export default function HeroSection() {
  ...
  const getHeroMarginTop = () => {
    return showBanner ? '48px' : '0px';
  };
      ...
      >
        ...
        <div className="relative h-screen flex flex-col justify-center items-center text-center pt-20">
          <div className="max-w-5xl mx-auto px-6">
            ...
            <p className="text-xl md:text-2xl max-w-2xl max-w-2xl mx-auto mb-12 font-light leading-relaxed" style={{ color: 'rgba(240, 230, 210, 0.9)' }}>
