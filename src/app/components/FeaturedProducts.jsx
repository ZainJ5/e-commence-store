...
export default function PremiumCarousel() {
  ...
  return (
    <div className="w-full min-h-screen bg-[#f8f7f5] flex items-center justify-center p-4 font-serif">
      <div className="relative w-full max-w-7xl">
        ...
        <button 
          onClick={prevSlide}
          className="absolute left-2 sm:left-6 top-1/2 -translate-y-1/2 z-30 w-10 h-10 sm:w-14 sm:h-14 rounded-full bg-white/10 backdrop-blur-md border border-gray-200 flex items-center justify-center text-gray-800 hover:bg-white/80 hover:shadow-lg transition-all duration-500 ease-out group"
        ...
        <button 
          onClick={nextSlide}
          className="absolute right-2 sm:right-6 top-1/2 -translate-y-1/2 z-30 w-10 h-10 sm:w-14 sm:h-14 rounded-full bg-white/10 backdrop-blur-md border border-gray-200 flex items-center justify-center text-gray-800 hover:bg-white/80 hover:shadow-lg transition-all duration-500 ease-out group"
        ...
        <motion.div 
          className="relative h-[700px] overflow-hidden rounded-3xl bg-gradient-to-b from-transparent to-[#f1efed]"
        ...
        >
          ...
          <motion.div
            ...
            style={{ 
              backgroundImage: `radial-gradient(circle at ${50 + direction * 10}% 50%, rgba(248,247,245,0.2), rgba(241,239,237,0.4))`,
            }}
          />
                    ...
                    <div className="relative w-full h-full">
                      ...
                      {isActive && (
                        ...
                        >
                          ...
                          <h3 className="text-xl sm:text-2xl font-medium tracking-wide mb-2 line-clamp-2">{product.title}</h3>
                          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-end gap-3">
                            ...
                            <div className="flex space-x-2 sm:space-x-4">
                              <motion.button 
                                className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-white/20 backdrop-blur-md flex items-center justify-center hover:bg-white/30 transition-all duration-300"
                                onClick={(e) => {
                                  e.stopPropagation();
                              ...
                              <motion.button 
                                className="py-1.5 sm:py-2 px-4 sm:px-6 rounded-full bg-white text-gray-900 text-xs sm:text-sm font-medium flex items-center justify-center hover:bg-gray-100 transition-all duration-300"
                                onClick={(e) => {
                                  e.stopPropagation();
                      ...
                      {isActive && (
                        <div className="absolute inset-0 rounded-xl ring-1 ring-white/40 ring-offset-0" />
                      )}
                    </div>
                  </div>
                </motion.div>
      ...
      <AnimatePresence>
        {showQuickView && (
          ...
          >
            <motion.div 
              className="bg-white rounded-xl p-4 sm:p-6 max-w-5xl w-full max-h-[90vh] overflow-auto flex flex-col md:flex-row"
            ...
            >
              <div className="md:w-1/2">
                <div className="rounded-lg overflow-hidden h-[300px] sm:h-[400px] md:h-[500px] bg-gray-100">
                  <motion.img 
              ...
              <div className="md:w-1/2 md:pl-6 lg:pl-10 pt-6 md:pt-0 flex flex-col">
                ...
                >
                  ...
                  <h2 className="text-2xl md:text-3xl font-medium mb-4">{products[activeIndex].title}</h2>
                  <div className="text-xl md:text-2xl mb-6">{products[activeIndex].price}</div>
                </motion.div>
                ...
                >
                  <h3 className="text-sm font-medium uppercase tracking-wide mb-3">Description</h3>
                ...
                >
                  <h3 className="text-sm font-medium uppercase tracking-wide mb-3">Size</h3>
                  <div className="flex flex-wrap gap-2 sm:gap-3">
                    {["XS", "S", "M", "L", "XL"].map((size, i) => (
                      <motion.button 
                        key={size} 
                        className="w-10 h-10 sm:w-12 sm:h-12 border border-gray-300 rounded-full flex items-center justify-center hover:border-gray-900 transition-all"
                        initial={{ opacity: 0, y: 10 }}
                        animate={{ opacity: 1, y: 0 }}
                ...
                >
                  <motion.button 
                    className="w-full py-3 sm:py-4 bg-gray-900 text-white rounded-full hover:bg-black transition-all flex items-center justify-center space-x-2 text-sm sm:text-base"
                  ...
                  <motion.button 
                    className="w-full py-3 sm:py-4 border border-gray-300 rounded-full hover:border-gray-900 transition-all flex items-center justify-center space-x-2 text-sm sm:text-base"
                ...
                <motion.button 
                  className="absolute top-3 right-3 sm:top-6 sm:right-6 w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-gray-100 flex items-center justify-center hover:bg-gray-200 transition-all"
                  onClick={() => setShowQuickView(false)}
